...
![npm](https://img.shields.io/npm/v/ai-k8s)
![Node.js](https://img.shields.io/badge/node-%3E%3D16.0.0-brightgreen)
![License](https://img.shields.io/npm/l/ai-k8s)
![TypeScript](https://img.shields.io/badge/typescript-%3E%3D4.0-blue)

# Kubernetes configuration and deployment automation utilities

Kubernetes configuration generator. Creates manifests and Helm charts for container orchestration.
## Usage
...
[![npm version](https://badge.fury.io/js/ai-k8s.svg)](https://badge.fury.io/js/ai-k8s)
